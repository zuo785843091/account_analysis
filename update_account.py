...
if __name__ == '__main__':
    ...
    try:
        ...
        if len(subjects) > 0:
            ...
            subjects_table_updated = []
            # 第一次清空一次
            clear_legacy_data = True
            ...
            for subject, subjects_table in zip(subjects, subjects_tables):
                ...
                # 一个sheet只清空一次
                if subjects_table in subjects_table_updated:
                    clear_legacy_data = False
                else:
                    clear_legacy_data = True
                ...
                xw_funs.update_account_analysis_table(wb1, subjects_table, dict_suppliers, subject, clear_legacy_data)
                subjects_table_updated.append(subjects_table)
                t_end = time.time()
